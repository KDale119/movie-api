...
public class ActorController {
    ...
    @Operation(
            ...
            summary = "Returns actor based on given ID",
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Actor JSON Body",
                    content = {
                            @Content(
    ...
    @Operation(
            ...
            summary = "Allows the user to delete an actor based on given ID",
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Actor JSON Body",
                    content = {
                            @Content(
    ...
    @Operation(
            ...
            summary = "Allows the user to create an actor",
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Actor JSON Body",
                    content = {
                            @Content(
    ...
    @Operation(
            ...
            summary = "Allows the user to update an actor based on given ID",
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Actor JSON Body",
                    content = {
                            @Content(
