...
public class MovieController {
    ...
    @Operation(
            ...
            summary = "Returns movie based on given ID",
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Movie JSON Body",
                    content = {
                            @Content(
    ...
    @Operation(
            ...
            summary = "Allows the user to delete a movie by ID",
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Movie JSON Body",
                    content = {
                            @Content(
    ...
    @Operation(
            ...
            summary = "Allows the user to create a movie",
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Movie JSON Body",
                    content = {
                            @Content(
    ...
    @Operation(
            ...
            summary = "Allows the user to update a movie by ID",
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Movie JSON Body",
                    content = {
                            @Content(
